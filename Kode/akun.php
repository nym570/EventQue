...
$role = $_SESSION['role'];
if($role=='mahasiswa'){
    $qr = $pdo->prepare("SELECT * FROM wishlist INNER JOIN event ON wishlist.eventid = event.id  WHERE wishlist.username = ? ORDER BY wishlist.id DESC");
